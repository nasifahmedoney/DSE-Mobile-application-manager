...
<a class="navbar-brand" href="userGroup_Admin.php" ><?php echo before('@',$user_email); ?></a>
    ...
    <ul class="navbar-nav">
	  ...
	  <li class="nav-item">
        <a class="nav-link" href="#"><b>Remove Purchase Power</b></a>
      </li>
...
<?php echo '<b>Remove Mobile Application Codes From New Database</b>';echo '<br>';echo '<p></p>' ?>

<form id = "form" action = "userGroup_Admin_RemovePurchasePower.php" method = "POST">
...
$query = "SELECT * FROM documents WHERE purchase_power ='set_90_percent'";
$result = mysqli_query($link,$query);
