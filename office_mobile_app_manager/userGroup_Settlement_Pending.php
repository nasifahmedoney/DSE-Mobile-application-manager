...
<?php echo "<p style = 'text-align:center'><b>Showing all pending codes</b></p>"; ?>
...
<?php
$query = "SELECT * FROM documents WHERE status = 'Pending' ORDER BY open_date DESC";
        ...
        if(is_array($row))
        {
            ...
            <tbody>
                <tr>
                    ...
                    <td style="text-align:center"><a href="userGroup_Settlement_ViewApplication.php?inv_code=<?php echo $row['investor_code']; ?>">View</a></td>
                </tr>
            </tbody>
