...
<a class="navbar-brand" href="userGroup_Admin.php" ><?php echo before('@',$user_email); ?></a>
    ...
    <ul class="navbar-nav">
	  ...
	  <li class="nav-item">
        <a class="nav-link" href="#"><b>Ledger Balance(Scan Document Not Available)</b></a>
      </li>
    </ul>
    </div>
...
<?php
$query = "SELECT * FROM old_documents WHERE status = 'Active' AND purchase_power = 'Ledger Balance'";
