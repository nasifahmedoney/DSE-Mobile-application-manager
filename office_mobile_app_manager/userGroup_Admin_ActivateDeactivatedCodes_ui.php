		...
		if(is_array($query_result1))
		{
		  ...
		  if($status == "Active")
		  {
			echo '<script type="text/javascript"> 
					alert("Investor Code Is Not Deactive.");
    ...
    <ul class="navbar-nav">
	  <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
		  ...
		  <a class="dropdown-item" href="#">Activate Deactive Codes</a>
	  ...
	  <li class="nav-item">
        <a class="nav-link" href="#"><b>Activate Deactive Codes</b></a>
      </li>
...
<form class="form-inline" name = "investor_code_search" id = "investor_code_search" action = "userGroup_Admin_ActivateDeactivatedCodes_ui.php" method = "POST">
...
<table class="table table-bordered">
  <thead>
    <tr>
      ...
      <th scope="col" style = "text-align:center">Activate Mobile Account</th>
    </tr>
  </thead>
    <tbody>
		<tr>
			...
			<td style = "text-align:center"><a href="userGroup_Admin_ActivateDeactivatedCodes.php?inv_code=<?php echo $inv_code; ?>">Click Here To Activate</a></td>
		</tr>
	</tbody>
</table>
</div>
