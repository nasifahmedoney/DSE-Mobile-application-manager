		...
		if(is_array($query_result1))//runs on new table
		{
		  ...
		  if($status == "Deactive")
		  {
			echo '<script type="text/javascript"> 
					alert("Can Not Change Purchase Power On Deactive Code.");
		  ...
		  {
			echo '<script type="text/javascript"> 
					alert("Investor Code not active.");
					window.location.href = "userGroup_Admin_EditPurchasePower.php";			
					</script>';  
		  }
		}
    ...
    <ul class="navbar-nav">
	  <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
		  ...
		  <a class="dropdown-item" href="#">Change Purchase Power</a>
...
<form class="form-inline" name = "investor_code_search" id = "investor_code_search" action = "userGroup_Admin_EditPurchasePower.php" method = "POST">
...
<table class="table table-bordered">
  <thead>
    <tr>
      ...
      <th scope="col" style = "text-align:center">Account Details</th>
    </tr>
  </thead>
    <tbody>
		<tr>
			...
			<td style = "text-align:center"><a href="userGroup_Admin_EditCode.php?inv_code=<?php echo $inv_code; ?>">Edit</a></td>
		</tr>
	</tbody>
</table>
