...
//run query for all the codes for that branch
...
else
{
	    echo '<script type="text/javascript"> 
			...
			window.location.href = "userGroup_User_SearchCode.php";			
			</script>';
}
...
<form class="form-inline" name = "investor_code_search" id = "investor_code_search" action = "userGroup_User_SearchCode.php" method = "POST">
