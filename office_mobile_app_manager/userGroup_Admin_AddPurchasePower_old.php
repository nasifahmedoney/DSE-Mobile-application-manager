...
<a class="navbar-brand" href="userGroup_Admin.php" ><?php echo before('@',$user_email); ?></a>
    ...
    <ul class="navbar-nav">
	  ...
	  <li class="nav-item">
        <a class="nav-link" href="#"><b>Add Purchase Power(Old)</b></a>
      </li>
...
<?php echo '<b>New Mobile Application Codes From Old Database</b>';echo '<br><p></p>'; ?>

<form id = "form" action = "userGroup_Admin_AddPurchasePower_old.php" method = "POST">
...
$query = "SELECT * FROM old_documents WHERE status = 'Active' AND purchase_power ='not_set'";
$result = mysqli_query($link,$query);
